...
function Login() {
    ...
    return (
        <div className="w-[100%]  flex justify-center items-center bg-slate-400">
            ...
            <form className="space-y-4 shadow-lg  sm:w-full px-10 md:w-[28%] bg-white justify-center items-center py-8 my-10 flex flex-col" onSubmit={handleSubmit}>
                ...
                <div class="flex flex-initial w-64">
                    <button className="mt-2 flex w-full justify-center rounded-sm bg-gray-400
                      w-[150px] px-3 py-2 
                    text-sm font-semibold leading-2 text-white shadow-sm hover:bg-indigo-500 
                    focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2
                     focus-visible:outline-indigo-600 mr-4">Facebook</button>

                    <button className="mt-2 flex w-full justify-center rounded-sm bg-gray-400 w-[160px]
